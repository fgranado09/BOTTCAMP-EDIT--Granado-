...
boton = tk.Button(ventana, text="Hola mundo", command= boton_presionado) # Creo un boton, en los argumentos tengo que aclarar dentro de donde va a ir ubicado y que texto va a tener
